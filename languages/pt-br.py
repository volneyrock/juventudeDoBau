...
'Escolha uma comunidade': 'Escolha uma comunidade',
'Escolha uma comunidade.': 'Escolha uma comunidade.',
...
'Value not in database': 'Valor não está na database',
'Verify Password': 'Confirmar senha',
'Videos': 'Vídeos',
'View': 'Visualização',
'Você precisa escolher uma comunidade para postar.': 'Você precisa escolher uma comunidade para postar.',
'Você precisa fazer parte de uma comunidade para postar.': 'Você precisa fazer parte de uma comunidade para postar.',
'Web2py': 'Web2py',
'Welcome': 'Bem-vindo',
